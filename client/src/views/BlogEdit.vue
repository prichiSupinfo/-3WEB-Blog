    ...
    <div class="form-wrapper">
        ...
        <form>
            ...
            <div class="blog-form-group">
                ...
                <textarea type="text" id="blogDescription" placeholder="INSERT BLOG TITLE HERE..." v-model="blog.text"/>
            </div>
                ...
                const requestOptions = {
                    ...
                    body: JSON.stringify({
                            ...
                            "article": {
                                ...
                                'text': this.blog.text,
                                'isHidden': this.blog.isHidden
                            }
                        })
                }

                var response = fetch('http://localhost:1337/article/update', requestOptions)
                .then(res => {
                    return res.json()
                })
                .then (json => {
                    if(json.result === "success") {
                        console.log('success')
                        const blogLink = '/blog/' + this.$route.params.id 
